...
/* create database gblog if not exists */
/* if database gblog is exists just drop */

DROP DATABASE IF EXISTS gblog;
create database gblog charset=utf8;
use gblog;
set charset utf8;
...
insert  into `t_option`(`id`,`name`,`value`) values (1,'sitename','gblog演示'),(2,'siteurl','http://www.ptapp.cn'),(3,'subtitle','基于Go语言和Beego框架的博客系统'),(4,'pagesize','10'),(5,'keywords','Go语言,博客程序,gblog'),(6,'description','基于Go语言和Beego框架的博客系统'),(7,'email','spxcds86@gmail.com'),(8,'theme','default'),(9,'timezone','8'),(10,'stat','');
